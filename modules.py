...
class AudioEncoder(nn.Module):
    def __init__(
        self, n_mels=128, n_ctx=None, audio_dim=768, text_dim=768, num_of_stride_conv=5,
    ):
        super().__init__()
        ...
        # Calculate n_ctx if not provided
        if n_ctx is None:
            n_frames = DURATION * SAMPLE_RATE // HOP_LENGTH + 1
            n_ctx = n_frames // (2 ** num_of_stride_conv) + 1
